...
Q_CONSTINIT static const qt_meta_stringdata_CLASSstartpageENDCLASS_t qt_meta_stringdata_CLASSstartpageENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(43, 12),  // "start_signal"
        QT_MOC_LITERAL(56, 24),  // "on_communication_clicked"
        QT_MOC_LITERAL(81, 9),  // "checkSlot"
        QT_MOC_LITERAL(91, 8),  // "exitSlot"
        QT_MOC_LITERAL(100, 13)   // "gamestartSlot"
    },
    "startpage",
    "check_record_signal",
    "",
...
void startpage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (startpage::*)();
            if (_t _q_method = &startpage::start_signal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
