...
public:
    ...
    void setupUi(QWidget *firstgame)
    {
        ...
        listView->setGeometry(QRect(0, 0, 241, 720));
        listView->setStyleSheet(QString::fromUtf8("border-image: url(:/shanhai.jpeg);"));
        yourscoreshow = new QLabel(firstgame);
        yourscoreshow->setObjectName("yourscoreshow");
        yourscoreshow->setGeometry(QRect(10, 120, 111, 51));
        yourscoreshow->setStyleSheet(QString::fromUtf8("font: 20pt \"\345\215\216\346\226\207\350\241\214\346\245\267\";"));
        score_label = new QLabel(firstgame);
        score_label->setObjectName("score_label");
        score_label->setGeometry(QRect(120, 120, 121, 51));
        score_label->setStyleSheet(QString::fromUtf8("font: 18pt \"\345\215\216\346\226\207\346\245\267\344\275\223\";"));
        ...
        SLabel->setGeometry(QRect(440, 660, 51, 41));
        ...
        ALabel->setGeometry(QRect(310, 660, 51, 41));
        ...
        DLabel->setGeometry(QRect(570, 660, 51, 41));
        ...
        JLabel->setGeometry(QRect(700, 660, 51, 41));
        ...
        KLabel->setGeometry(QRect(830, 660, 51, 41));
        ...
        time_show->setGeometry(QRect(10, 50, 111, 41));
        time_show->setStyleSheet(QString::fromUtf8("font: 20pt \"\345\215\216\346\226\207\350\241\214\346\245\267\";"));
        time_label = new QLabel(firstgame);
        time_label->setObjectName("time_label");
        time_label->setGeometry(QRect(120, 50, 101, 41));
        QFont font;
        ...
        time_label->setStyleSheet(QString::fromUtf8("font: 18pt \"\345\215\216\346\226\207\346\245\267\344\275\223\";"));
        listView_2 = new QListView(firstgame);
        listView_2->setObjectName("listView_2");
        listView_2->setGeometry(QRect(240, 630, 840, 95));
        listView_2->setStyleSheet(QString::fromUtf8("border-image: url(:/wave.jpg);"));
        listView_2->raise();
        listView->raise();
        yourscoreshow->raise();
        score_label->raise();
