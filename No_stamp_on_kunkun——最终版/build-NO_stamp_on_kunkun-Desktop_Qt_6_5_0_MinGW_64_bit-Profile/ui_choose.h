...
public:
    ...
    void setupUi(QWidget *choose)
    {
        ...
        label->setStyleSheet(QString::fromUtf8("border-image: url(:/Kaer_Morhen.png);"));
        normal_game = new QPushButton(choose);
        normal_game->setObjectName("normal_game");
        normal_game->setGeometry(QRect(430, 160, 211, 91));
        QFont font;
        ...
        back->setGeometry(QRect(430, 500, 211, 91));
        QFont font1;
        font1.setFamilies({QString::fromUtf8("\345\215\216\346\226\207\350\241\214\346\245\267")});
        font1.setPointSize(20);
        back->setFont(font1);
        infi_game = new QPushButton(choose);
        infi_game->setObjectName("infi_game");
        infi_game->setGeometry(QRect(430, 320, 211, 91));
        infi_game->setFont(font);
        listView = new QListView(choose);
        listView->setObjectName("listView");
        listView->setGeometry(QRect(0, 0, 1080, 720));
        listView->raise();
        label->raise();
        normal_game->raise();
        back->raise();
    ...
    void retranslateUi(QWidget *choose)
    {
        ...
        infi_game->setText(QCoreApplication::translate("choose", "\346\227\240\345\260\275\346\250\241\345\274\217", nullptr));
    } // retranslateUi
