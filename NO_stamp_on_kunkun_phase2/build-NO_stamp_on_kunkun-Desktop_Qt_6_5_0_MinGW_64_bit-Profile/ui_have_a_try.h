...
public:
    ...
    void setupUi(QWidget *have_a_try)
    {
        ...
        check_record = new QPushButton(have_a_try);
        check_record->setObjectName("check_record");
        check_record->setGeometry(QRect(130, 640, 391, 71));
        check_record->setMouseTracking(true);
        check_record->setStyleSheet(QString::fromUtf8("font: 20pt \"\345\215\216\346\226\207\350\241\214\346\245\267\";\n"
"\n"
"\n"
""));
        check_record->setAutoRepeat(false);
        check_record->setFlat(false);

        retranslateUi(have_a_try);

        check_record->setDefault(true);
    ...
    void retranslateUi(QWidget *have_a_try)
    {
        ...
        check_record->setText(QCoreApplication::translate("have_a_try", "\346\210\221\344\274\232\345\245\275\345\245\275\345\212\252\345\212\233\347\232\204(\346\221\201\346\255\244\350\277\224\345\233\236)", nullptr));
    } // retranslateUi
